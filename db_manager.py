...
def insert_pokemons(pokemons):
    try:
        ...
        raise HTTPException(
            status_code=500, detail="DB Error - insert_pokemons")
...
def insert_pokemons_types(pokemons_types):
    try:
        ...
        raise HTTPException(
            status_code=500, detail="DB Error - insert_pokemons_types")
...
def heaviest_pokemon():
    try:
        ...
        raise HTTPException(
            status_code=500, detail="DB Error - heaviest_pokemon")
...
def pokemons_by_type(type):
    try:
        ...
        raise HTTPException(
            status_code=500, detail="DB Error - pokemons_by_type")
...
def find_owners(pokemon_name):
    try:
        with connection.cursor() as cursor:
            query = f'''
            SELECT trainer_name FROM pokemons_trainers as pt,
...
def find_roster(trainer_name):
    try:
        with connection.cursor() as cursor:
            query = f'''
            SELECT name FROM pokemons as p, pokemons_trainers as pt
...
def get_pokemon_by_id(pokemon_id):
    try:
        ...
        raise HTTPException(
            status_code=500, detail="DB Error - get_pokemon_by_id")
